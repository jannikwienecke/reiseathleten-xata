...
// export function Tabl2<TData extends ARecord>({
//   columns,
//   dataList,
//   title,
//   subtitle,
...
//   function toggleAll() {
//     setSelected(checked || indeterminate ? [] : dataList);
...
//                     <input
//                       type="checkbox"
//                       className="absolute left-6 top-1/4 -mt-2 h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600"
//                       ref={checkbox}
//                       checked={checked}
//                       onChange={toggleAll}
//                       style={{
...
//                     >
//                       <a href="123" className="group inline-flex">
//                         {column.header}
